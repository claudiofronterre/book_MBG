...
load("./data/fit_malkenya.rds")
load("./data/pred_age15.rds")
load("./data/pred_aver_pop.rds")
load("./data/lb_pred_S_m.rds")
lb_pred_S_m$obs_loc <- FALSE
load("./data/lb_pred_S_j.rds")
lb_pred_S_j$obs_loc <- FALSE
liberia_grid <- lb_pred_S_j$grid_pred
an_fit <- readRDS("./data/an_fit.rds")
load("./data/regularized.rds")
regularized_scores <- regularized
load("./data/cluster.rds")
cluster_scores <- cluster
load("./data/pred_shp.rds")
load("data/pred_shp_w.rds")
load("data/fit_sp_lib.rds")
library(dplyr)
