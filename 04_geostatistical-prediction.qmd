...
transformation of $S(x)$ and themodel fitted to the data is a linear
...
`predict_over_grid()` function in RiskMap, to sample from the predictive
...
methods for data splitting, using the `spatial_clusterin_cv()` function
...
3.  In the analysis of the *Anopheles gambiae* moqsuitoes data, consider
    two models. One that uses elavation, with linear predictor
