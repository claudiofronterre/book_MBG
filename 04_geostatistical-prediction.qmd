...
we shall use the function `assess_sim()`, from the RiskMap package,
...
can use as the input to the function `assess_sim()` which performs Step 3
...
The assessment is conducted using `assess_sim()`, where the prevalence
