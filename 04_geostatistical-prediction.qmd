...
The function `surf_sim()` in RiskMap can be used to carry out all these
...
The function `surf_sim()` also requires a sampling functions that
...
Using the output from the `surf_sim()` function, named `lib_surf_sim`, we
