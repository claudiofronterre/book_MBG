...
analysis of the riverblindness in Liberia, our interest lies in
...
riverblindness mentioned at the start of the this section, a more
...
denoting with $T(x)$ riverblindness prevalence as defined in
...
#| fig-height: 6
#| label: fig-clus-loc
#| fig-cap: "Examples of the use of spatial clustering methods for the splitting of the Liberia data on riverblindness."
...
#| fig-height: 6
#| label: fig-reg-loc
#| fig-cap: "Examples un the use of spatialky regularized thinning for the splitting of the Liberia data on riverblindness into training and test set. The plots show the resulting test sets by randomly selecting 20 locations from the original dataset and imposing a minimum distance of 30km (left panel) and 40km (right panel)."
library(spatialEco)
set.seed(123)
...
example on riverblindness mapping in Liberia.
...
4.  Consider the Liberia dataset on riverblindness. Carry out a
