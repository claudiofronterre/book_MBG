...
Finding a nearby cell is an imputation: it attempts to recover the value of the covariate at the point. A buffer summary answers a different question by defining the covariate as exposure over a neighbourhood. A mean within a radius can be appropriate for a continuous or intensive quantity when surrounding conditions are scientifically relevant, whereas a sum may be appropriate for an extensive quantity such as population count. The next example illustrates the mechanics of a buffer summary.
