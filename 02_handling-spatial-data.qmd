...
# Inspect source, licence and attribution metadata
gb_get_metadata("Liberia", adm_lvl = "adm0")
gb_get_metadata("Liberia", adm_lvl = "adm1")
```
...
plot(sf::st_geometry(liberia_admin0))
plot(sf::st_geometry(liberia_admin1))
```
...
plot(sf::st_geometry(liberia_admin0), add = TRUE)
```
...
par(mar = c(0, 0, 0, 0))  #| hide_line
plot(sf::st_geometry(liberia_admin0_utm), col = "white")
